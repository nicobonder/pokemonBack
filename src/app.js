...
res.header('Access-Control-Allow-Origin', 'pokemonfront.up.railway.app');
...
res.header('Access-Control-Allow-Origin', 'pokemon.up.railway.app'); // update to match the domain you will make the request from
